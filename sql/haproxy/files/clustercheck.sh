...
# GRANT PROCESS ON *.* TO 'clustercheckuser'@'localhost' IDENTIFIED BY 'clustercheckpasswordWillBeChangedInProd';
...
MYSQL_PASSWORD="clustercheckpasswordWillBeChangedInProd"
